import { AIInsightsCard } from '@src/components/features/SimulationResults/AIInsightsCardProps'
import { Card } from '@src/components/features/SimulationResults/Card'
...
export function SimulationResultsPage() {
  ...
  return (
    <main className="max-w-6x1 mx-auto px-4 py-10 sm:py-14">
      ...
      />
      <p className="mb-6 text-sm text-zinc-600">Poupança mensal estimada: {monthlySavings}</p>
